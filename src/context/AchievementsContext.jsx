...
export const ACHIEVEMENTS = {
    ...
    about_fly: { id: 'about_fly', label: '滚动飞越我的故事', title: '天空行者' },
    studio_interact: { id: 'studio_interact', label: '拖动旋转浏览', title: '导演' },
    gallery_inspect: { id: 'gallery_inspect', label: '点击项目查看详情', title: '艺术评论家' },
