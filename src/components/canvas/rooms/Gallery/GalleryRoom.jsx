...
const FALLBACK_PROJECTS = [
    {
        ...
        description: 'MoneTune 是一份循序渐进的指南，教初学者如何利用 AI 创作音乐来产生被动收入。无需任何音乐技能，你就能学会轻松制作专业曲目，将其发布到 Spotify 等平台，并实现数字资产的变现。',
    ...
    },
    {
        ...
        description: 'TimberKitty 是一款令人上瘾的免费浏览器街机游戏，使用纯 JavaScript 构建。玩家操控一只伐木猫砍柴、拯救小鸟、完成每日任务，并在全球排行榜上竞争。',
    ...
    },
    {
        ...
        description: '一个时尚现代的概念网站，专为波兰说唱歌手兼创作者 Young Multi 打造。它作为推广落地页，旨在凸显其个人品牌、音乐和网络形象。',
    ...
    },
    {
        ...
        description: '一个快速、现代的个人简介页面，作为我数字足迹的中心枢纽。展示我最新的编程项目、网页开发服务、YouTube 视频和推荐的音乐人。',
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* 第 3 层：覆盖整个按钮的不可见 hit-area - 捕获所有事件 */}
                    <mesh
                        position={[0, 0, 0.02]}
                        onClick={(e) => {
                ...
                <group
                    ref={detailsGroupRef}
                    position={[0, -0.5, 0]} // 顶部位置（Y=0.75 为底部，Y=-0.4 为顶部）
                    rotation={[Math.PI, 0, 0]}
                >
                    <Text
                        ref={detailsTextRef1}
                        position={[0, 0.28, 0.01]} // 相对于 detailsGroupRef 中心，靠上
                        fontSize={0.10}
                        color="#1c1c1c"
                        font="/fonts/CabinSketch-Bold.ttf"
                        anchorX="center"
                    ...
                    <Text
                        ...
                        fillOpacity={0} // Start hidden
                    >
                        {project.description || "这是一段示例描述文本，用于在项目暂无描述时占位展示。它会出现在项目卡片的详情区域，帮助排版与视觉呈现。"}
                    </Text>
                </group>
