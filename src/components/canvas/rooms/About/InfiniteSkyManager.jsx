...
const AWARDS_DATA = {
    featured: {
        ...
        title: '精选项目合集',
        items: [
            { label: '精选 - Awwwards', date: '2025 年 5 月', image: '/textures/about/FEATURED.webp', url: 'https://awwwards.com' },
            { label: '精选 - CSS Design Awards', date: '2025 年 6 月', image: '/textures/about/FEATURED.webp', url: 'https://cssdesignawards.com' },
            { label: '精选 - The FWA', date: '2025 年 7 月', image: '/textures/about/FEATURED.webp', url: 'https://thefwa.com' },
            { label: '精选 - Behance', date: '2025 年 8 月', image: '/textures/about/FEATURED.webp', url: 'https://behance.net' },
        ],
        platformConfig: {
            label: '荣誉',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        title: '每日精选网站奖项',
        items: [
            { label: '每日最佳 - GSAP', date: '2026 年 2 月 13 日', image: '/textures/about/SOTDAYYOUNGMULTIGSAP.webp', url: 'https://www.linkedin.com/posts/greensock_site-of-the-day-young-multi-this-immersive-activity-7427567524940017664-zU2n?utm_source=share&utm_medium=member_desktop&rcm=ACoAAE3TV6UBqXoaJXUN5-1s3ij6SQJwTRAcbCM' },
            { label: '每日最佳 - CSS Winner', date: '2026 年 1 月 24 日', image: '/textures/about/SOTDAYYOUNGMULTICSSWINNER.webp', url: 'https://www.csswinner.com/details/young-multi-official-experience/19045' },
            { label: '每日最佳 - Orpetron', date: '2026 年 1 月 29 日', image: '/textures/about/SOTDAYYOUNGMULTIORPETRON.webp', url: 'https://orpetron.com/sites/young-multi/' },
            { label: '每日最佳 - Design Nominees', date: '2026 年 2 月 17 日', image: '/textures/about/SOTDAYYOUNGMULTIDESIGNNOMINESS.webp', url: 'https://www.designnominees.com/sites/young-multi' }
        ],
        platformConfig: {
            label: '奖项',
            color: '#1a1a1a',
